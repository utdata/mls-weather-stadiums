...
summer_winter_date_function <- function(years) {
  ...
  summer_winter_weeks_short_year <- summer_winter_weeks_base 
  summer_winter_weeks_short_year[25:35] <-  summer_winter_weeks_base[25:35] - 52
  
  summer_winter_weeks_long_year <- summer_winter_weeks_base 
  ...
  for (i in seq_along(years)) {
    ...
    if (yr == 2010){
      ...
      if (get_iso_weeks(yr) == 52){
        ...
        for (j in seq(1,24)){
          wk <- summer_winter_weeks_short_year[j]
      ...
      if (get_iso_weeks(yr)==53){
        ...
        for (j in seq(1,25)){
          wk <- summer_winter_weeks_long_year[j]
...
```{r}
years2 <- years[1:14]
spring_fall_dates <-  spring_fall_date_function(years2)
```
